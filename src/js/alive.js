...
const Alive = (function () {
    return {
        ...
        handleBlogScreen: (landerTL) => {
            const blogScreenBtn = document.querySelector('#blogs-screen-btn');
            const blogsScreen = document.querySelector('#blogs-screen');
            const closeBlogScreen = blogsScreen.querySelector('.close-btn');
            
            const h2 = blogsScreen.querySelector('h2 span');
            const socialTitle = blogsScreen.querySelector('.social-title p');
            const socialLinks = blogsScreen.querySelectorAll('.social-links li .nav-link');
            ...
            closeBlogScreen.addEventListener('click', () => {
                let contactTL = gsap.timeline();
